...
import org.server.tools.RunnableExecuteFactory;
 ...
 *
 */
//@GameComponent.Setting(id = 10001, loadOrder = 10001, name = "MessageProcessComponent")
public class MessageProcessComponent implements //org.server.backend.component.GameComponent, 
		IMessageProcess,
		ILogicDeadMessageProcess {

	static final Logger log = LoggerFactory
			.getLogger(MessageProcessComponent.class);

	RunnableExecuteFactory executeFactory;
	...
	public void load() {
		this.executeFactory = new RunnableExecuteFactory("MessageHandleCenter");
	 ...
	 *            会话消息
	 */
	public void fireMessageReceived(int nodeId, long sessionId,
			SessionMessage data) {
	...
	void fireModelReceived(GameSession session, CallbackDefine define,
