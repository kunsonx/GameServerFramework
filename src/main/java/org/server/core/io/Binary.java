...
public class Binary {
     ...
     *
     * @param <T> 共享模块类型F
     * @param createSharedModule 模块创建器
     * @param message 会话消息数据
     * @return 序列化成功返回模块
     */
    public static <T extends com.google.protobuf.GeneratedMessage> T tryDeserialize(CreateSharedModule<T> createSharedModule, SessionMessage message) {
        try {
     ...
     * @return 序列化成功的数据
     */
    public static byte[] trySerialize(com.google.protobuf.GeneratedMessage module) {
        try {
